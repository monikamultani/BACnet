...
class Chat(Frame):
    ...
    def save(self, message, chatID):
        ...
        content = Content('chat/saveMessage', {'messagekey': to_save, 'chat_id': chatID, 'timestampkey': time.time()})
...
logo_path = os.path.join(dirname, '../Grafiken/BAC_net_Logo.png')
name_path = os.path.join(dirname, '../Grafiken/BAC_net.png')
